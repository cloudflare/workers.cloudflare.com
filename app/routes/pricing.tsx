    ...
    products: [
      ...
      },
      {
        ...
        components: [
          ...
          { name: "KV Reads", included: "None", unit: "per million rows", price: "$0.20" },
          { name: "KV Writes", included: "None", unit: "per million rows", price: "$1.00" },
          { name: "KV Deletes", included: "None", unit: "per million rows", price: "$1.00" },
