...
const WorksPage = () => {
  return (
    <Layout>
      ...
      <div className="antialiased text-black dark:text-white">
        <div className="md:max-w-4xl mx-auto pt-16 pb-8">
          <div className="text-center mt-16 mb-12">
            <h1 className="text-4xl mb-4 font-bold">Works on Workers</h1>
            <h2 className="text-xl">
              The best packages and libraries supported by Cloudflare Workers, chosen by <a className="Link" href="https://discord.gg/cloudflaredev">our community</a>
            </h2>
          </div>
          ...
          <div className="text-center">
            ...
            />
            <p className="my-4">
              <a className="Link" href="https://airtable.com/shrtvoM4QfEr48ZoQ">Submit new packages</a>
            </p>
          </div>
        </div>

        <div className="md:max-w-3xl mx-auto mt-12 pt-8 pb-32">
          <h2 className="text-center text-4xl pt-4 pb-12">FAQ</h2>

          <h3 className="text-xl font-semibold">Does Workers supports React/Angular/Svelte/your frontend framework of choice?</h3>
          ...
          <h3 className="text-xl font-semibold pt-4">A package that you suggested doesn't work!</h3>
          ...
          <h3 className="text-xl font-semibold pt-4">What packages don't work?</h3>
