    ...
    <Layout>
        ...
        <div className="HeroSection--column">
          <div className="HeroSection--content">
            <h1 className="HeroSection--title">
              ...
              <div className="HeroSection--title-second-line">
                We handle the rest.
              </div>
            </h1>
            ...
            <div className="HeroSection--key-points">
              <ul className="UnorderedListWorkersThemed UnorderedListWorkersThemed-is-primary">
                <li>
                  From signup to globally deployed in <strong>&lt;5min</strong>
                </li>
                <li>
                  Your code runs within <strong>milliseconds</strong> of your
                  users worldwide
                </li>
                <li>
                  Say goodbye to cold starts—support for{" "}
                  <strong>0ms&nbsp;worldwide</strong>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="HeroSection--illustration">
            <div className="HeroSection--illustration-card">
              <pre
                className="CodeBlock CodeBlock-is-hero CodeBlock-scrolls-horizontally CodeBlock--language-sh"
                language="sh"
              >
                <code className="CodeBlock--code">
                  ...
                  <br />
                  <u>
                    <b className="CodeBlock--token-directory">~/my-app</b>{" "}
                    <b className="CodeBlock--token-prompt">$</b>{" "}
                  </u>
                  npx wrangler deploy
                  <u>
                    ...
                    <b className="CodeBlock--token-value">
                      https://my-app.world.workers.dev
                    </b>
                  </u>
                </code>
              </pre>
      ...
      <section className="QuoteSection">
        <div className="QuoteSection--column">
          <cite className="QuoteSection--cite">
            ...
            >
              <svg
                ...
                viewBox="0 0 16 5"
                fill="currentColor"
                aria-labelledby="QuoteSection--svg-logo-title QuoteSection--svg-logo-desc"
              >
                <title id="QuoteSection--svg-logo-title">NPM</title>
                <desc id="QuoteSection--svg-logo-desc">
                  Logo for the company NPM
                </desc>
          ...
          <blockquote className="QuoteSection--quote">
            <p>
              “Cloudflare Workers has changed the way we build our apps. We
              don’t have to think about regions, we just deploy code and it runs
      ...
      <section className="GreatPowerSection">
        <h2 className="GreatPowerSection--title">
          <div className="GreatPowerSection--title-first-line">
            Great power.
          </div>
        ...
        <div className="BenefitsSection--column">
          <div className="BenefitsSection--benefits">
            <div className="BenefitsSection--benefit">
              <div className="BenefitsSection--benefit-illustration">
                <img
                  ...
                  src="./resources/illustrations/scaling.svg"
                />
              </div>
              ...
              <div className="BenefitsSection--benefit-description">
                ...
                capacity you don’t use. Traffic is automatically routed and load
                balanced across thousands of servers. Sleep well as your code
                scales effortlessly.
              </div>
            </div>
            <div className="BenefitsSection--benefit">
              ...
              >
                <img
                  ...
                  src="./resources/illustrations/global-network.svg"
                />
              </div>
              <div
                className="BenefitsSection--benefit-illustration"
                dark-theme-only="true"
              >
                <img
                  alt="Global network illustration"
                  src="./resources/illustrations/global-network-dark-theme.svg"
                />
              </div>
              <h3 className="BenefitsSection--benefit-title">
              ...
              <div className="BenefitsSection--benefit-description">
                <div className="MarkdownLite">
                  <p>
                    Every deploy is made to a network of data centers running{" "}
                    <span className="PopoverTarget" data-js-popover="isolates">
                      V8 isolates
                    </span>
            ...
            <div className="BenefitsSection--benefit">
              ...
              >
                <img
                  ...
                  src="./resources/illustrations/templates.svg"
                />
              </div>
              <div
                className="BenefitsSection--benefit-illustration"
              ...
              >
                <img
                  alt="Templates illustration"
                  src="./resources/illustrations/templates-dark-theme.svg"
                />
              </div>
              <h3 className="BenefitsSection--benefit-title">
              ...
              <div className="BenefitsSection--benefit-description">
                Choose from a template in your language to kickstart building an
                ...
                <a
                  className="Link"
                  href="https://developers.cloudflare.com/workers/get-started/guide#2-install-the-workers-cli"
                >
                  CLI
                </a>{" "}
            ...
            <div className="BenefitsSection--benefit">
              ...
              >
                <img
                  ...
                  src="./resources/illustrations/short-cold-starts.svg"
                />
              </div>
              <div
                className="BenefitsSection--benefit-illustration"
              ...
              >
                <img
                  alt="Short cold starts illustration"
                  src="./resources/illustrations/short-cold-starts-dark-theme.svg"
                />
              </div>
              <h3 className="BenefitsSection--benefit-title">
              ...
              <div className="BenefitsSection--benefit-description">
                <div className="MarkdownLite">
                  <p>
                    Most serverless platforms experience a cold start every time
                    you deploy or your service increases in popularity. Workers
                    can run your code instantly, without cold starts.
                  </p>
                </div>
              </div>
            </div>
            <div className="BenefitsSection--benefit">
              ...
              >
                <img
                  alt="Low-cost illustration"
                  src="./resources/illustrations/low-cost.svg"
                />
              </div>
              <div
                className="BenefitsSection--benefit-illustration"
              ...
              >
                <img
                  alt="Low-cost illustration"
                  src="./resources/illustrations/low-cost-dark-theme.svg"
                />
              </div>
              <h3 className="BenefitsSection--benefit-title">
              ...
              <div className="BenefitsSection--benefit-description">
                <div className="MarkdownLite">
                  <p>
                    The first 100,000 requests each day are free and paid plans
                    start at just $5/10 million requests, making Workers as much
                    as <strong>ten-times less expensive</strong> than other
                    serverless platforms.
                  </p>
                  <p className="BenefitsSection--benefit-description-footnote-p">
                    For a 50ms Worker compute workload including API Gateway
            ...
            <div className="BenefitsSection--benefit">
              <div className="BenefitsSection--benefit-illustration">
                <img
                  ...
                  src="./resources/illustrations/serverless.svg"
                />
              </div>
              <h3 className="BenefitsSection--benefit-title">
              ...
              <div className="BenefitsSection--benefit-description">
                ...
                servers, and no containers to spin up or manage. Deploy using
                our CLI, web interface, or API.
              </div>
            </div>
            <div className="BenefitsSection--benefit">
              <div
              ...
              >
                <img
                  alt="Workers Unbound illustration"
                  src="../resources/illustrations/bundled.svg"
                />
              </div>
              <div
                className="BenefitsSection--benefit-illustration"
              ...
              >
                <img
                  alt="Workers Unbound illustration"
                  src="../resources/illustrations/bundled-dark-theme.svg"
                />
              </div>
              <h3 className="BenefitsSection--benefit-title">
              ...
              <div className="BenefitsSection--benefit-description">
                <div className="MarkdownLite">
                  <p>
                    Store your static assets at the edge with Workers KV, our
                    global, low-latency key-value data store. Access your assets
                    alongside your code and transform them via powerful APIs
                    (e.g. HTMLrewriter) to modify your page before it reaches
                    the user.
                  </p>
                </div>
              </div>
            ...
            <div className="BenefitsSection--benefit">
              ...
              >
                <img
                  alt="Static to dynamic illustration"
                  src="../resources/illustrations/static-to-dynamic.svg"
                />
              </div>
              <div
                className="BenefitsSection--benefit-illustration"
              ...
              >
                <img
                  ...
                  alt="Static to dynamic illustration"
                  src="../resources/illustrations/static-to-dynamic-dark-theme.svg"
                />
              </div>
              <h3 className="BenefitsSection--benefit-title">
              ...
              <div className="BenefitsSection--benefit-description">
                Say goodbye to build steps which pre-generate thousands of
                assets in advance. Harness the unrivaled raw power of the edge
                to generate images, SVGs, PDFs, whatever you need,{" "}
                <em>on the fly</em>, and deliver them to users as quickly as a
                static asset.
              </div>
            </div>
          </div>
        ...
        <div className="CustomerLogosSection--logos">
          <div className="CustomerLogosSection--logos-frame">
            <div className="CustomerLogosSection--logos-content">
              <img
                className="CustomerLogosSection--logo"
                alt="23andMe logo"
                src="./resources/customer-logos/23andme.svg"
                style={{ "--aspect-ratio": 0.4, transform: "scale(1.5)" }}
              />
              <img
                className="CustomerLogosSection--logo"
                alt="Broadcom logo"
                src="./resources/customer-logos/broadcom.svg"
                style={{ "--aspect-ratio": 0.2 }}
              />
              <img
                className="CustomerLogosSection--logo"
                alt="CodePen logo"
                src="./resources/customer-logos/codepen.svg"
                style={{ "--aspect-ratio": 0.23 }}
              />
              <img
                className="CustomerLogosSection--logo"
                alt="Cordial logo"
                src="./resources/customer-logos/cordial.svg"
                style={{ "--aspect-ratio": 0.4, "--vertical-adjust": -0.07 }}
              />
              <img
                className="CustomerLogosSection--logo"
                alt="Discord logo"
                src="./resources/customer-logos/discord.svg"
                style={{ "--aspect-ratio": 0.32, "--vertical-adjust": 0.02 }}
              />
              <img
                className="CustomerLogosSection--logo"
                alt="DoorDash logo"
                src="./resources/customer-logos/doordash.svg"
                style={{ "--aspect-ratio": 0.22 }}
              />
              <img
                className="CustomerLogosSection--logo"
                alt="Glossier logo"
                src="./resources/customer-logos/glossier.svg"
                style={{ "--aspect-ratio": 0.3 }}
              />
              <img
                className="CustomerLogosSection--logo"
                alt="Marketo logo"
                src="./resources/customer-logos/marketo.svg"
                style={{ "--aspect-ratio": 0.25 }}
              />
              <img
                className="CustomerLogosSection--logo"
                alt="MaxMind logo"
                src="./resources/customer-logos/maxmind.svg"
                style={{ "--aspect-ratio": 0.22, "--vertical-adjust": -0.16 }}
              />
              <img
                className="CustomerLogosSection--logo"
                alt="NPM logo"
                src="./resources/customer-logos/npm.svg"
                style={{ "--aspect-ratio": 0.38 }}
              />
              <img
                className="CustomerLogosSection--logo"
                alt="Optimizely logo"
                src="./resources/customer-logos/optimizely.svg"
                style={{ "--aspect-ratio": 0.27, "--vertical-adjust": -0.18 }}
              />
              <img
                className="CustomerLogosSection--logo"
                alt="ProPublica logo"
                src="./resources/customer-logos/propublica.svg"
                style={{ "--aspect-ratio": 0.25, "--vertical-adjust": -0.12 }}
              />
              <img
                className="CustomerLogosSection--logo"
                alt="Timely logo"
                src="./resources/customer-logos/timely.svg"
                style={{ "--aspect-ratio": 0.3, "--vertical-adjust": -0.14 }}
              />
            </div>
          </div>
        </div>
              ...
              <div className="PlansSection--plan-header">
                ...
                <div className="PlansSection--plan-subtitle">
                  <span className="Number Number-is-strong">
                    <span className="Number--number">100,000</span>
                  </span>{" "}
                  requests per day
                </div>
            ...
            <div className="PlansSection--plan PlansSection--plan-is-bundled">
              ...
              <div className="PlansSection--plan-details">
                <ul className="UnorderedListWorkersThemed">
                  ...
                  <li className="PlansSection--plan-details-list-alignment-item">
                    &nbsp;
                  </li>
                  <li className="PlansSection--plan-details-list-alignment-item">
                    &nbsp;
